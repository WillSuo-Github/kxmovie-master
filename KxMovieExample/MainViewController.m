...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    KxMovieViewController *vc = [KxMovieViewController movieViewControllerWithContentPath:@"http://resv.wangfanwifi.com/cms/videos/hangmei/yinghan2.mp4" parameters:parameters];
